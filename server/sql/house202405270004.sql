...
CREATE TABLE `comment`  (
  ...
  `parent_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关联被回复的评论id',
...
CREATE TABLE `user`  (
  ...
  `fullname` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '姓名',
  ...
  `is_active` int NULL DEFAULT NULL COMMENT '是否已激活',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',

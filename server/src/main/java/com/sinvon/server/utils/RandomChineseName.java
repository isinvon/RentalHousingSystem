...
public class RandomChineseName {
    ...
    // 创建一个中国姓氏的数组
    String[] surname = {"林", "习", "范", "樊", "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦", "尤", "许", "何", "吕", "施", "张", "孔", "曹", "严", "华", "金", "魏", "陶", "姜", "戚", "谢", "邹", "喻", "柏", "水", "窦", "章", "云", "苏", "潘", "葛", "奚", "彭", "郎", "鲁", "韦", "昌", "马", "苗", "凤", "花", "方", "俞", "任", "袁", "柳", "酆", "鲍", "史", "唐", "费", "廉", "岑", "薛", "雷", "贺", "倪", "汤", "滕", "殷", "罗", "毕", "郝",};
    // 创建一个随机汉字
    char randomChinese = RandomUtil.randomChinese();
    // 创建一个随机数,从1和2中随机选择
    int choice = RandomUtil.randomInt(1, 3);
     ...
     * @return
     */
    public String getRandomChineseNameSelectLength(int length) {
